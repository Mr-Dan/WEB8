    ...
    */
    if(isset($_POST["btn_submit_register"]) && !empty($_POST["btn_submit_register"])){
        ...
        if(isset($_POST["captcha"]) && !empty($captcha)){
            ...
            $allname = $first_name . " ". $last_name ;
            $reg_person = $mysqli->prepare("INSERT INTO person (email, password,Person_name) VALUES (?, ?, ?)");
            $reg_person->bind_param("sss",  $email,$password,$allname);
            $reg_person->execute();
