...
?>
    ...
    <div class="col-12 authorizationWoodLandsquare" > 
...
?>
        ...
        <form action="php/authorization.php" method="post" class="form_auth">
         ...
         <a class="link_auth_vk" href="https://oauth.vk.com/authorize?client_id=7707071&display=page&redirect_uri=http://localhost/php/vk.php&response_type=code">
        <img src="img/vk.png"/>
    </a>
                    </td>
                </tr>
